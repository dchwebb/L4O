...
private:
	...
	static constexpr std::string_view productString      = "Mountjoy L4O";
	static constexpr std::string_view cdcString          = "Mountjoy L4O CDC";
	static constexpr uint8_t selfPowered = 0;				// Set to 1 if self powered
	static constexpr uint16_t ProductId = 65434;
